...
export const SearchBook = () => {
  ...
  const schema = yup.object().shape({
    ...
    searchType: yup.string().required().oneOf(["title", "author"]),
  });
  ...
  const menuItemsData = [
    ...
    { value: "keywords", label: "Słowa kluczowe" },
  ];
    ...
    >
      ...
      >
        <Controller
          ...
          defaultValue="title"
          render={({ field }) => (
            <WithLabel id={selectId} text="opcje szukania">
              <Select
                {...field}
                sx={{
                  width: isMobileMax ? "100%" : "auto",
        ...
        <Controller
          ...
          control={control}
          render={({ field }) => (
            <WithLabel id={inputId} text="pole wyszukiwarki">
              <TextField
                sx={{
                  flexGrow: 1,
                  background: "aliceblue",
